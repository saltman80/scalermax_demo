...
if (!process.env.VITE_SCALERMAX_BACKEND_KEY) {
  console.error('❌ Missing VITE_SCALERMAX_BACKEND_KEY in environment, using default')
  process.env.VITE_SCALERMAX_BACKEND_KEY = 'xyz789-scalermax-secret'
}
